...
function Vacancies() {
    ...
    const categories = [
        {
            categoryName: 'IT',
            subCategories: ['Web', 'Security', 'QA', 'Network']
        },
        {
            categoryName: 'Bank',
            subCategories: ['Kredit mütəxəssisi', 'Analitik', 'Əməliyyatçı', 'Şöbə müdiri']
        },
        {
            categoryName: 'Marketinq və Satış',
            subCategories: '',
        }
    ]
                ...
                <div className="vacancies_page_filters_container">
                    ...
                    <ul className="vacancies_page_filters_boxes_container">
                        <li className="vacancies_page_filters_box">
                            <CustomSelectOption select_option_name={'Kateqoriya'} select_option_array={categories} />
                        </li>                        
                    </ul>
                </div>
                {/* vacancies boxes */}
